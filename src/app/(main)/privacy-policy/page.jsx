...
const Prose = ({ children }) => (
  <p className="theme-text-faint text-sm leading-relaxed mb-4">{children}</p>
);
...
const BulletList = ({ items }) => (
  <ul className="space-y-2 mb-4">
    {items.map((item, i) => (
      <li
        key={i}
        className="flex items-start gap-2.5 text-sm theme-text-faint leading-relaxed"
      >
...
const SubLabel = ({ children }) => (
  <p className="theme-text-secondary text-sm font-medium mb-1.5 mt-4">
    {children}
  </p>
);
...
const PrivacyPolicyPage = () => {
  return (
    <>
      ...
      <section className="min-h-screen bg-bg-base py-24">
        <div className="container-fluid max-w-6xl mx-auto px-4">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-2 mb-4">
              <Link
                href="/"
                className="theme-text-faint text-xs hover:text-primary transition-colors"
              >
                Home
              </Link>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              <div>
                ...
                <h1 className="theme-text-primary text-4xl lg:text-5xl font-bold leading-tight">
                  Privacy Policy
                </h1>
                <p className="theme-text-faint text-base mt-3 max-w-xl leading-relaxed">
              ...
              <div className="flex gap-4 shrink-0">
                <div className="theme-surface border border-primary/10 rounded-xl px-4 py-3 text-center">
                  <p className="theme-text-faint text-[10px] uppercase tracking-widest mb-1">
                    Effective
                  </p>
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <aside className="lg:sticky lg:top-24 w-full lg:w-56 shrink-0">
              <div className="theme-surface border border-primary/10 rounded-2xl p-5">
                <p className="theme-text-faint text-[10px] uppercase tracking-[0.2em] font-semibold mb-4">
                  Contents
                </p>
                <nav className="space-y-1">
                  {SECTIONS.map((s) => (
                    <a
                      key={s.id}
                      href={`#${s.id}`}
                      className="flex items-center gap-2.5 theme-text-faint text-xs py-1.5 px-2 rounded-lg hover:bg-primary/10 hover:theme-text-secondary transition-all group"
                    >
            ...
            {/* Content */}
            <div className="flex-1 min-w-0 theme-surface border border-primary/10 rounded-2xl p-6 lg:p-10">
              <SectionTitle
                id="collect"
                number="01"
              ...
              <Prose>
                ...
                through your use of our service. This falls into three
                categories:
              </Prose>
              ...
              <Prose>
                ...
                at any time. Disabling non-essential cookies will not affect
                core functionality.
              </Prose>
              ...
              <Prose>
                ...
                16 in the EU). We do not knowingly collect personal data from
              ...
              <Prose>
                ...
                displaying a prominent notice on our platform at least 14 days
              ...
              {/* Contact card */}
              <div className="bg-bg-base border border-primary/15 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-2">
                <div>
                  <p className="theme-text-primary text-sm font-medium mb-0.5">
                    Privacy team
                  </p>
