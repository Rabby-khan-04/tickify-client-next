const MainSectionTitle = ({ subtitle = "", title = "", description = "" }) => {
  return (
    <div className="max-w-2xl mx-auto flex flex-col justify-center items-center mb-20">
      <span className="inline-block border border-primary/30 text-primary text-sm px-5 py-2 rounded-full mb-6 bg-primary/10">
        {subtitle}
      </span>

      <h2 className="font-bold text-[clamp(1.6rem,3vw,2rem)] tracking-wider text-text-primary text-center mb-2">
        {title}
      </h2>
