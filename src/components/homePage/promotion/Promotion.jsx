  ...
  return (
    <section className="p-top pb-8">
      <div className="container-fluid grid grid-cols-1 lg:grid-cols-6 gap-8">
        {/* Promo Card — always purple, text always white */}
        <div className="lg:col-span-4 p-6 rounded-xl bg-secondary flex max-sm:flex-col items-center">
          <div className="grow">
            ...
            <p className="text-base sm:text-lg text-white mb-2">
              ...
              movies together. Don{"'"}t miss out—this offer is only for
              students and for a limited time!
            </p>
            <button className="btn-ghost text-white! border-white!">
        ...
        <div className="lg:col-span-2 bg-bg-card border border-border-subtle rounded-xl p-6">
          <h3 className="text-[clamp(1.2rem,2vw,32px)] font-semibold mb-2 text-text-primary">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            />
            <h3 className="text-[clamp(1rem,1.8vw,28px)] text-text-primary font-medium">
              F1: The Movie
            </h3>
          </div>
